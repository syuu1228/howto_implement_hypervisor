...
$key = q/includegraphics{figuresslashpart3_fig1_IO_bitmaps.eps};LFS=12;FSF=1.6;AAT/;
...
$cached_env_img{$key} = q|<IMG
 WIDTH="374" HEIGHT="74" ALIGN="BOTTOM" BORDER="0"
 SRC="|."$dir".q|img1.png"
 ALT="\begin{program}
% latex2html id marker 15
\centering
\begin{verbatim}unsigned ...
...R);
}\end{verbatim}
